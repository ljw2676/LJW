				...
				<div class="colorlib-narrow-content">
					<div class="row">
						<div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
							...
							<h2 class="colorlib-heading" style="margin-top: -10px;">나의 신고 내역</h2>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="progress-table-wrap">
							<div class="progress-table">
								<div class="table-head" >
									...
									<div class="country" style="position:relative; left:180px; ">모임명</div>
									<div class="visit" style="position:relative; left:310px;">신고 사유</div>
								</div>
								<c:choose>
								...
								<div class="table-row" >
									<div class="serial" style="position:relative; left:55px;"><span style="text-align: center;">${row.R_NO }</span></div>
									<div class="country" style="position:relative; left:280px; "><span style="text-align: center;">${row.GG_NAME }</span></div>
									<div class="visit" style="position:relative; left:335px; "><span style="text-align: center;">${row.R_COMMENT }</span></div>
								</div>
								</c:forEach>
								</c:when>
								<c:otherwise>
