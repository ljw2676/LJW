				...
				<div class="col-lg-6 nopadding">
					...
					<div class="register_section d-flex flex-column align-items-center justify-content-center">
						<div class="register_content text-center">
							<h1 class="register_title">YOU ENTERED<br><span> INCORRECTLY</span></h1>
							<div class="button button_1 register_button mx-auto trans_200"><a href="#" onclick="end()">GO BACK</a></div>
						</div>
					</div>
